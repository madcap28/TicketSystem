...
namespace TicketSystem.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Title,Description,Date,Email,Status,CustomerResponse,EmployeeResponse,ScheduledTime,ScheduledDay")] Ticket ticket)
        {
